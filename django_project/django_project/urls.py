...
from django.contrib.auth import views as auth_views # in built django views for login and logout
...
urlpatterns = [
    ...
    path('',include('blog.urls')), # urls.py file inside blog app included in main project urls
...
if settings.DEBUG == True:
    # when debug mode is on find media url here
